...
<ul className="list-disc pl-5 space-y-1">
  <li>
    💬 Be the face of <strong>Gemini AI</strong> at your college
  </li>
  <li>
    ⚙️ Run <strong>200+ Gemini prompts</strong> per month
  </li>
...
<p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
  ✅ <strong>Commitment Required:</strong> 5–7 hours/week from July to December
  2025
</p>
