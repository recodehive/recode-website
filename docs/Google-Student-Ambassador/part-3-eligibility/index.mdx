...
<ul className="list-disc pl-5 space-y-1">
  <li>
    Are <strong>18+ years</strong> old
  </li>
  <li>
    Are currently enrolled in a <strong>college in India</strong>
  </li>
  <li>
    Can commit <strong>5–7&nbsp;hrs/week</strong> for 6 months
  </li>
  <li>
    Are passionate about <strong>AI & tech</strong>
  </li>
