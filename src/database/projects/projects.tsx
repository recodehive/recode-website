...
const projectsData: OurProjectsData = {
  ...
  description:
    'Discover our diverse projects showcasing all the begineer friendly opensource contributions, innovative applications. Each project represents our commitment to excellence and continuous learning.',
  items: [
    {
