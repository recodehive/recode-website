...
const testimonials = [
  ...
  },
  {
    ...
    review:
      'I am pleased to provide my review of an exceptional course by Darshil Parmar that serves as an excellent introduction to a data engineering career. Unlike traditional SQL learning paths, this course focuses on PostgreSQL, offering a unique and real-time experience of project work. By showcasing your practical skills, it enhances job prospects. The course not only imparts technical knowledge but also nurtures an understanding of professional data engineering. I highly recommend this course to anyone looking for innovative ways to learn SQL and kickstart their data engineering journey',
    stars: 5,
  },
];
      ...
      <main className="bg-black min-h-screen text-white">
        ...
        >
          ...
          <motion.div className="mt-8" variants={fadeIn}>
            <h3 className="text-lg text-gray-400 mb-2 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative z-10">
            {testimonials.map((t, idx) => (
              ...
              >
                ...
                <h4 className="font-bold mb-3 text-xl bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-300 group-hover:from-blue-400 group-hover:to-purple-400 transition-all duration-300">
                  {t.name}
                </h4>
                ...
                <p className="text-gray-300 text-sm text-center line-clamp-4 group-hover:text-gray-200 transition-colors duration-300">
                  {t.review}
                </p>
              </motion.div>
            ))}
                ...
                .map((course, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-300 group-hover:from-blue-400 group-hover:to-purple-400 transition-all duration-300">
                        {course.title}
                      </h3>
                    ...
                    <svg
                      className="w-6 h-6 text-gray-400 group-hover:text-blue-400 transform group-hover:translate-x-1 transition-all duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <React.Fragment key={course.number}>
                  ...
                  >
                    ...
                    {idx !== courses.length - 1 && (
                      <div className="w-1 h-16 bg-transparent"></div>
                    )}
                  </motion.div>
                </React.Fragment>
              ))}
