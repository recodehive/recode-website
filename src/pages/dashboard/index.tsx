      ...
      const transformedData: LeaderboardEntry[] = data.leaderboard
        ...
        .map((item, index) => {
          ...
          return {
            ...
            avatar:
              item.avatar_url ||
              `https://avatars.githubusercontent.com/u/${Math.floor(Math.random() * 100000)}?v=4`,
                      ...
                      {leaderboardData.map((entry, index) => (
                        ...
                        >
                          ...
                          <div className="rank-section">
                            <div
                              className={`rank-badge ${entry.rank <= 3 ? `rank-${entry.rank}` : 'rank-other'}`}
                            >
                              #{entry.rank}
                            </div>
                          </div>
              ...
              <>
                ...
                >
                  <div className="hero-content">
                    ...
                    <p className="dashboard-subtitle">
                      Participate in exclusive giveaways and win exciting
                      prizes!
                    </p>
                  </div>
                </motion.section>
