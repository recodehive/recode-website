            ...
            <div className="mb-12 grid gap-8 lg:grid-cols-2">
                <AnimatePresence>
                    {filteredQuestions.map((question, index) => (
                        <motion.div
                            key={question.id}
                            className={`relative flex h-full flex-col overflow-hidden rounded-2xl border-2 bg-white/95 shadow-xl backdrop-blur-sm transition-all duration-500 hover:shadow-2xl dark:bg-gray-800/95 ${activeSession?.questionId === question.id
                                ...
                                <AnimatePresence mode="wait">
                                    {activeSession?.questionId === question.id ? (
                                        ...
                                        <motion.button
                                            ...
                                            className={`flex w-full items-center justify-center space-x-3 rounded-xl border-2 py-4 font-black shadow-2xl transition-all ${completedQuestions.has(question.id)
